...
int main()
{
    ...
    t0 = clock();
    assert(fish_csidh(&pub_alice, &base, &priv_alice));
    t1 = clock();
    ...
    t0 = clock();
    assert(fish_csidh(&pub_bob, &base, &priv_bob));
    t1 = clock();
    ...
    t0 = clock();
    assert(fish_csidh(&shared_alice, &pub_bob, &priv_alice));
    t1 = clock();
    ...
    t0 = clock();
    assert(fish_csidh(&shared_bob, &pub_alice, &priv_bob));
    t1 = clock();
