...
REccPoint ECNRPRF::prf(block input) {
  ...
  std::vector<droidCrypto::REccNumber> ECNRPRF::getKeys(){
    return this->a_;
  }
  droidCrypto::REccBrick ECNRPRF::getBrick(){
    return this->brick_;
  }

  droidCrypto::REllipticCurve ECNRPRF::getCurve(){
    return this->curve_;
  }
  droidCrypto::REccNumber ECNRPRF::geta0(){
    return this->a0_;
  }
