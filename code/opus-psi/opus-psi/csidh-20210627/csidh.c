...
static bool validate_rec(bool *is_supersingular, limbs *order, uint8_t *seen, proj *P, proj const *A, size_t lower, size_t upper)
{
  assert(lower < upper);
  ...
  limbs cl = uint_1, cu = uint_1, *cc = &cu;
